        ...
        <section class="content-header">
            <div class="row">
                <div class="col-sm-12 col-md-8">
                    <h3 class="top-left-header">Numeraciones Inactivas </h3>
                    <input type="hidden" class="datatable_name" data-title="Facturación" data-id_name="datatable">
                </div>
                <div class="col-sm-12 col-md-4">
                    <a class="btn_list m-right btn btn-primary" href="<?php echo base_url() ?>facturas/">
                         Listado numeraciones Activas
                    </a>
                </div>
            </div>
        </section>
                     ...
                     <table id="datatable" class="table table-responsive">
                         ...
                         <tbody>
                                ...
                                <?php else : ?>
									...
									<tr>
										<td><?php echo $numeracion->id; ?></td>
										<td><?php echo $numeracion->TipoDoc; ?></td>
										...
										<td>
											<a class="" href="#"><?php echo $numeracion->num_ini ;
												if ($numeracion->num_fin != NULL) { echo " - " . $numeracion->num_fin; } ?></a>
										</td>
										<td>
											<a class="" href="#"><?php 
                                            if ($numeracion->estado == 0){
												echo '<span class="badge bg-danger tip-left">Desactivado</span>';
                                            }elseif ($numeracion->estado == 2){
												echo '<span class="badge bg-warning tip-left">Agotado</span>';
                                            }; ?></a>
										</td>
										...
										<td class="ir_txt_center">
											<div class="btn-group actionDropDownBtn">
												...
												<ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="dropdownMenuButton1" role="menu">
                                                    ...
                                                    <?php if ($numeracion->estado == 0) : ?>
                                                        <li><a href="<?php echo base_url() . 'facturas/activar_numeracion/' . $numeracion->id; ?>"  class="delete" href=""><i
                                                                    class="fa fa-check tiny-icon"></i>Volver a Activar</a>
                                                        </li>
                                                    <?php endif; ?>
												</ul>
											</div>
