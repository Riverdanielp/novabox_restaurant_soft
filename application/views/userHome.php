...
<html>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower_components/numpad/jquery.numpad.css?v=7.5">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower_components/numpad/theme.css?v=7.5">
    <!--datepicker-->
    <!-- bootstrap datepicker -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower_components/datepicker/datepicker.css?v=7.5">
    <!-- bootstrap datepicker -->
    <script src="<?php echo base_url(); ?>assets/bower_components/datepicker/bootstrap-datepicker.js?v=7.5"></script>
    <!-- Select2 -->
    <script src="<?php echo base_url(); ?>assets/bower_components/select2/dist/js/select2.full.min.js?v=7.5"></script>
    <!-- Select2 -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/perfect-scrollbar/dist/perfect-scrollbar.css?v=7.5">
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo escape_output($favicon) ?>" type="image/x-icon">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/css/AdminLTE.css?v=7.5">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/css/custom/userHome.css?v=7.5">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/css/common.css?v=7.5">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/nice-select/css/nice-select.css?v=7.5">
    <!-- Slick Slidear CSS -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/slick-slider/slick.css?v=7.5">
    <!-- Google Font -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/local/google_font.css?v=7.5">
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/custom_tooltip.css?v=7.5">
    <script src="<?php echo base_url(); ?>frequent_changing/js/user_home.js?v=7.5"></script>
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>frequent_changing/css/userHomeResponsive.css?v=7.5">
        ...
        <aside class="<?php echo isset($language) && $language=="arabic" ? 'main-sidebar2' : 'main-sidebar'?>">
            ...
            <a href="javascript:void(0)" class="logo-wrapper">
                ...
                <span class="logo-lg irestora_font_div">
                     <img src="<?php echo escape_output($system_logo); ?>" style="width: 190px; height: 40px;">
                </span>
            </a>
            <!-- Admin Logo Part End -->
            <section class="sidebar">
                ...
                <div id="left_menu_to_scroll">
                    ...
                    <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
                        ...
                        <li class="treeview menu__cidirp_22222 common_use">
                            <a href="javascript:void(0)">
                                <i data-feather="settings"></i>
                                <span><?php echo lang('sos_online_order'); ?></span>
                            </a>
                            <ul class="treeview-menu">
                                <li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_22222"><a href="<?php echo base_url()?>setting/onlineOrderEnableDisable">
                                 <?php echo lang('enable_disable'); ?></a></li>
                                <?php if($getCompanyInfo->sos_enable_online_order=="Yes"):?>
                                    <li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_22222"><a href="<?php echo base_url()?>setting/urlGenerator">
                                    <?php echo lang('urlGenerator'); ?></a></li>
                                    <li data-access="all_setting-358" class="menu_assign_class" data-menu__cid="irp_22222"><a href="<?php echo base_url()?>setting/orderReceivingUserOnlineOrder">
                                    <?php echo lang('order_receiving_user'); ?></a></li>
                                <?php endif?>
                        ...
                        <li class="treeview menu__cid8 sale_customer">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li data-access="pos_1-73" class="menu_assign_class" data-menu__cid="8"><a class="child-menu" href="<?php echo base_url()?>POSChecker/posAndWaiterMiddleman">
...
?>
    ...
    <!-- FastClick -->
    <script src="<?php echo base_url(); ?>assets/bower_components/fastclick/lib/fastclick.js?v=7.5"></script>
    <script src="<?php echo base_url(); ?>assets/plugins/nice-select/js/jquery.nice-select.min.js?v=7.5"></script>
    <!-- AdminLTE App -->
    <script src="<?php echo base_url(); ?>assets/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js?v=7.5"></script>

    <script src="<?php echo base_url(); ?>assets/dist/js/adminlte.min.js?v=7.5"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="<?php echo base_url(); ?>assets/dist/js/demo.js?v=7.5"></script>
    <script src="<?php echo base_url(); ?>assets/dist/js/menu.js?v=7.5"></script>
