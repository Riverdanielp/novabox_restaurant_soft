                            ...
                            <select tabindex="4" class="form-control  select2" name="ingredient_id"
                                ...
                                foreach ($ingredients as $ingnts) {
                                    if (!in_array($ingnts->id, $ignoreID)) {
                                        $ignoreID[] = $ingnts->id;
                                        $last_purchase_price = getLastPurchaseAmount($ingnts->id);
                                        $conversion_rate = 1;
                                        if($ingnts->conversion_rate){
                                            $conversion_rate =  $ingnts->conversion_rate;
                                        }
                                        $inline_total = ($last_purchase_price/$conversion_rate);
                                        ?>
                                        <option
                                                value="<?php echo escape_output($ingnts->id . "|" . $ingnts->name . " (" . $ingnts->code . ")|" . $ingnts->unit_name . "|" . $inline_total) ?>"
                ...
                <div class="row" id="food_menu_waste_quantity_row" class="ir_display_none">
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input tabindex="1" type="number" readonly id="waste_quantity" name="food_menu_waste_qty"
