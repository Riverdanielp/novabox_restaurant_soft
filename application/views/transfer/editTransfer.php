            ...
            <div class="table-box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="clearfix"></div>
                        <div class="col-sm-12 col-md-4 col-lg-3 mb-2 display_none"  style="display: <?php echo $display_none_1?>">
                            <div class="form-group">
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                            <tr class="rowCount" data-item_id="<?=$value->ingredient_id?>" data-id="<?=$key?>" id="row_<?=$key?>">
                                                ...
                                                <td><input type="text" data-countid="1" tabindex="51"  value="<?=$value->quantity_amount?>" id="quantity_amount_1" name="quantity_amount[]" onfocus="this.select();"  <?=$readonly_11?> class="form-control integerchk aligning countID cal_culate" placeholder="Cant/Monto"><span class="label_aligning"><?=$unit?></span></td>
