            ...
            <div class="table-box">  
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="form-group">
                                ...
                                <select name="outlet_id" class="select2 form-control">
                                    ...
                                    ?>
                                    <option value="<?php echo escape_output($value->id) ?>"><?php echo escape_output($value->outlet_name) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="cmb-3 col-lg-4 col-md-6 inv_qr_code_status">
                            <div class="form-group">
                                ...
                                <option value="Disable"><?php echo lang('disable'); ?></option>
                                    <option value="Enable"><?php echo lang('regular_qrcode'); ?></option>
                                    <option value="Zatca"><?php echo lang('zatca_qrcode'); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="clearfix"></div>

                        <div class="col-sm-12 mb-2 col-md-4 col-lg-4 div_direct_print">
                            <div class="form-group">
                        ...
                        <div class="col-sm-12 mb-2 col-md-4 col-lg-4 network_div1 div_direct_print">
                            <div class="form-group">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <input tabindex="1" autocomplete="off" type="text" name="printer_ip_address" id="printer_ip_address" class="form-control" placeholder="<?php echo lang('printer_ip_address'); ?>" value="<?php echo set_value('printer_ip_address'); ?>">
                                        </td>
                                        <td> 
                                        <div class="tooltip_custom">
                            ...
                            <div class="form-group">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <input tabindex="1" autocomplete="off" type="text" name="printer_port" id="printer_port" class="form-control" placeholder="<?php echo lang('printer_port'); ?>" value="<?php echo set_value('printer_port'); ?>">
                                        </td>
                                        <td> 
                                        <div class="tooltip_custom">
                        ...
                        <div class="clearfix"></div>
                            <div class="mb-3 col-sm-12 col-md-4 col-lg-4 div_direct_print">
                                <div class="form-group">
                ...
                <div class="box-footer">
                    ...
                    <div class="ipvfour_address_div div_direct_print me-2">
                        <a target="_blank" class="btn bg-blue-btn test_print" href="javascript:void(0)">
