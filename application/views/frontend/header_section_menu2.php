...
<!-- Header Start -->
<header class="main-header header-1 header-4 header-light header-absolute header-section-menu">
  ...
  <div class="container">
    <nav class="navbar">
      ...
      <ul class="navbar-nav">
        ...
        <li class="menu-item menu-item-has-children">
          <a href="<?php echo base_url() . 'about-us'; ?>" class="<?= str_contains($current_url, 'about-us') ? 'active' : '' ?>"><?php echo lang('about_us'); ?></a>
        </li>
        <li class="menu-item menu-item-has-children">
          <a href="<?php echo base_url() . 'online-order'; ?>" class="<?= str_contains($current_url, 'online-order') || str_contains($current_url, 'checkout') || str_contains($current_url, 'food-details') ? 'active' : '' ?>"><?php echo lang('Order_Online'); ?></a>
        </li>
        <?php if($company_info->sos_enable_reservation=="Yes"):?>
        <li class="menu-item menu-item-has-children">
          <a href="<?php echo base_url() . 'reservation'; ?>" class="<?= str_contains($current_url, 'reservation') ? 'active' : '' ?>"><?php echo lang('reservation'); ?></a>
        </li>
        <?php endif?>
        <li class="menu-item menu-item-has-children">
          <a href="<?php echo base_url() . 'contact-us'; ?>" class="<?= str_contains($current_url, 'contact-us') ? 'active' : '' ?>"><?php echo lang('contact_us'); ?></a>
        </li>
      </ul>
