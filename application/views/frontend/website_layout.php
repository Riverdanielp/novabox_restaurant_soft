...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/plugins/bootstrap.min.css?v=7.5">
  <script src="<?php echo base_url(); ?>assets/bower_components/jquery/dist/jquery.min.js?v=7.5"></script>
  <!-- Vendor Stylesheets -->
  <script src="<?php echo base_url() ?>assets/website/js/plugins/bootstrap.min.js?v=7.5"></script>
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/plugins/animate.min.css?v=7.5">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/plugins/magnific-popup.css?v=7.5">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/plugins/slick.css?v=7.5">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/plugins/slick-theme.css?v=7.5">
  <!-- Icon Fonts -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/fonts/flaticon/flaticon.css?v=7.5">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/fonts/font-awesome/css/all.min.css?v=7.5">
  <!-- Owl Carousel -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/owl-carousel/css/owl.carousel.min.css?v=7.5">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/owl-carousel/css/owl.theme.default.css?v=7.5">
  <!-- Owl Carousel -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/nice-select2.css?v=7.5">
  <!-- Page Specific Styles -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/plugins/leaflet.css?v=7.5">
  ...
  <!-- Slices Style sheet -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/website/css/style.css?v=7.5">
  <!-- New Style Css -->
  <link rel="stylesheet" href="<?php echo base_url() ?>frequent_changing/frontend/style.css?v=7.5">
  <!-- RTL Styles -->
  <?php
  if (isset($language) && $language == "arabic") {
  ?>
    <link rel="stylesheet" href="<?php echo base_url() ?>frequent_changing/frontend/rtl.css?v=7.5">
  <?php
  }
  ?>
  <!-- Responsive Css -->
  <link rel="stylesheet" href="<?php echo base_url() ?>frequent_changing/frontend/responsive.css?v=7.5">
  <!-- Favicon -->
...
<body class="<?php echo isset($language) && $language == "arabic" ? 'arabic-lang"' : '' ?>">
  ...
  <input type="hidden" id="delivery_amount_hidden" value="<?php echo $company_info->delivery_amount ?>">
  ...
  <!-- Vendor Scripts -->
  <script src="<?php echo base_url() ?>assets/website/js/plugins/popper.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/waypoint.js?v=7.5"></script>

  <script src="<?php echo base_url() ?>assets/website/js/plugins/jquery.magnific-popup.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/jquery.slimScroll.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/imagesloaded.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/jquery.steps.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/jquery.countdown.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/isotope.pkgd.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/plugins/slick.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/owl-carousel/js/owl.carousel.min.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/nice-select2.js?v=7.5"></script>

  <!-- Slices Scripts -->
  <script src="<?php echo base_url() ?>assets/website/js/main.js?v=7.5"></script>

  <!-- Page Specific Scripts -->
  <script src="<?php echo base_url() ?>assets/website/js/plugins/leaflet.js?v=7.5"></script>
  <script src="<?php echo base_url() ?>assets/website/js/order.js?v=7.5"></script>
