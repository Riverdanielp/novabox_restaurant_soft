  ...
  <div class="container">
    <nav class="navbar">
      ...
      <ul class="navbar-nav">
        ...
        <li class="menu-item menu-item-has-children">
          <a href="<?php echo base_url() . 'online-order'; ?>" class="<?= str_contains($current_url, 'online-order') || str_contains($current_url, 'food-details')? 'active' : '' ?>"><?php echo lang('Order_Online'); ?></a>
        </li>
        <?php if($company_info->sos_enable_reservation=="Yes"):?>
          <li class="menu-item menu-item-has-children">
