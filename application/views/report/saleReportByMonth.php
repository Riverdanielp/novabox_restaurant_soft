...
<section class="content-header">
    <h3 class="ir_txtCenter_mt0"><?php echo lang('Monthly_Sale_Report'); ?></h3>
    <hr class="ir_border1">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-offset-3 col-md-2">
            <div class="form-group">
                <a target="_blank"
                    href="<?= base_url() . 'PdfGenerator/saleReportByMonth/' ?><?= isset($start_date) ? $this->custom->encrypt_decrypt($start_date, 'encrypt') : '0'; ?>/<?= isset($end_date) ? $this->custom->encrypt_decrypt($end_date, 'encrypt') : '0'; ?>/<?= isset($user_id) ? $this->custom->encrypt_decrypt($user_id, 'encrypt') : '0'; ?>"
        ...
        <div class="col-md-12">
            ...
            <div class="table-box">
                ...
                <div class="box-body table-responsive">
                    <h3><?php echo lang('Monthly_Sale_Report'); ?></h3>
                    <?php
