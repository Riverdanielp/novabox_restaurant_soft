        ...
        <div class="box-wrapper">
            ...
            <div class="table-box">
                        ...
                        <div class="col-sm-12 mb-2 col-md-3">
                            <div class="form-group">
                                ...
                                <table>
                                    ...
                                    <option <?php echo set_select('designation','Chef')?> <?php echo isset($user_details->designation) &&  $user_details->designation=="Chef"?'selected':''?> value="Chef"><?php echo lang('Chef'); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                foreach ($outlets as $value) {
                                    ...
                                    <label class="container mt-2"> 
                                        <input class="outlet_class" type="checkbox" name="outlets[]"
                                        <?=escape_output($checked)?>  <?php echo set_checkbox('outlets[]', $value->id); ?> value="<?php echo escape_output($value->id) ?>"> <?php echo escape_output($value->outlet_name) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2 col-md-3">
                                <div class="form-group radio_button_problem">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input tabindex="5" type="radio" name="print_kitchen" id="print_kitchen_yes"
                                                value="Yes"
                                                <?php if($user_details->print_kitchen=="Yes"){echo "checked";} ?>><?php echo lang('yes'); ?> </label>
                                        <label>

                                            <input tabindex="6" type="radio" name="print_kitchen" id="print_kitchen_no" value="No"
                                                <?php if($user_details->print_kitchen=="No"){echo "checked";} ?>><?php echo lang('no'); ?>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="print_pos_id">
                                        ...
                                        <?php foreach ($printers as $printer):?>
                                            <option <?php echo $user_details->print_pos_id == $printer->id ? 'selected' : ''; ?> <?php echo set_select('print_pos_id',$printer->id)?> value="<?php echo escape_output($printer->id); ?>"><?php echo escape_output($printer->title); ?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-12 mb-2 col-md-3">
                                <div class="form-group">
                                    <label><?php echo lang('login_pin'); ?></label>
                                    <div class="d-flex">
                                        <input tabindex="9" type="text" id="login_pin"  onfocus="select();"  name="login_pin" class="form-control me-1"
                                           placeholder="<?php echo lang('login_pin'); ?>"
                                           value="<?php echo escape_output($user_details->login_pin) ?>">
                                        <a class="new-btn generate_now pull-right"><?php echo lang('Generate'); ?></a>
                                    </div>
                ...
                <div class="box-footer">
                    ...
                    <a class="btn bg-blue-btn" href="<?php echo base_url() ?>User/users">
