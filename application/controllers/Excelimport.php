    ...
    public function ExcelDataAdd() {
        if ($_FILES['userfile']['name'] != "") {
            if ($_FILES['userfile']['name'] == "Customer.xlsx") {
                ...
                $this->session->set_userdata('exception_err', "No podemos aceptar otros archivos, descargue el archivo de muestra 'Customer.xlsx', fill it up properly and upload it.");
            }
        } else {
